		...
		<div id="wrap">
			...
			<div class="navbar navbar-default navbar-fixed-top">
				<div class="container">
				    ...
				    <a class="navbar-brand" href="#">MAT v22</a>
				  </div>
				  <div class="collapse navbar-collapse">
				    <ul class="nav navbar-nav">
				      <li class="dropdown">
				        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Watch <b class="caret"></b></a>
...
<div id="footer">
  <div class="container">
    <p class="text-muted credit">Copyright <a href="#">Rotariu Dan Andrei</a>.</p>
  </div>
</div>
